<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:102:"E:\share\lol.git\trunk\thinkphp_5.0.20_with_ext\public/../application/lol\view\cash_confirm\index.html";i:1531292458;}*/ ?>
<html>
<head>
    <title>LOL</title>
    ...
    <script>
        function CashConfirm(type, cash_id, user_id, ydc) {
            ...
            xmlhttp.open("GET", "/index.php/lol/cash_confirm/"+type+"?cash_id="+cash_id+"&user_id="+user_id+"&ydc="+ydc, true);
            xmlhttp.send()
