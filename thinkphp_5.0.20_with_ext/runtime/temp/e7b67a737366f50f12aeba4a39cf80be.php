<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:102:"E:\share\lol.git\trunk\thinkphp_5.0.20_with_ext\public/../application/lol\view\index\match_invest.html";i:1531116865;}*/ ?>
<html>
<head>
    <title>LOL</title>
    ...
    <script type="text/javascript">
        function MatchInfoInvest(id){
            window.open("/index.php/lol/index/matchinfoinvest?id="+id);
//            var xmlhttp;
