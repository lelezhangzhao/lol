    ...
    <ul>
        ...
        <li id="personinfo"><a href="#">个人信息</a>
            <ul>
                ...
                <li id="fixsecondpassword"><a href="#">修改二级密码</a></li>
            </ul>
        </li>
